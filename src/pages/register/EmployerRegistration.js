...
import { useRegiseterMutation } from "../../features/auth/authApiIn";
import { useSelector } from "react-redux";
import { toast } from "react-toastify";

const EmployerRegistration = () => {
  // const [countries, setCountries] = useState([]);
  const [postRegister, { isLoding, error, isError, isSuccess }] =
    useRegiseterMutation();
  ...
  const onSubmit = (data) => {
    postRegister(data);
    toast.success("registion succefully", { autoClose: 2000 });
    navigate("/");
  };
